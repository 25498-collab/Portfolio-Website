    ...
    <section id="top" className="w-full bg-gallery">
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-28">
        <div className="inline-flex items-center gap-2 rounded-full border border-cement px-4 py-1.5">
          ...
          <span className="font-mono-tech text-[11px] tracking-[0.15em] uppercase text-onyx/60">A website for your business · from $400</span>
        </div>
        ...
        <p className="mt-7 max-w-xl text-lg leading-relaxed text-onyx/70">
          ...
          complete and ready to launch, for a flat <strong className="text-onyx">$400</strong>.
        </p>
        ...
        <div className="mt-12 flex flex-wrap gap-x-8 gap-y-2">
          {["Fixed $400 price", "Ready in a week", "Mobile-friendly", "No ongoing fees"].map((t) => (
